export const COURSES = [
  ...
  },
  {
    ...
    titleKey: "courses.aiFundamentals.title",
    descriptionKey: "courses.aiFundamentals.description",
    icon: "fas fa-robot",
    order: 2,
    difficulty: "beginner",
  ...
  {
    id: "ai-productivity-improvement",
    ...
    titleKey: "courses.aiProductivityImprovement.title",
    descriptionKey: "courses.aiProductivityImprovement.description",
    icon: "fas fa-rocket",
    order: 3,
  ...
  {
    id: "ai-critical-thinking-problem-solving",
    ...
    titleKey: "courses.aiCriticalThinkingProblemSolving.title",
    descriptionKey: "courses.aiCriticalThinkingProblemSolving.description",
  ...
  },
  {
    ...
    titleKey: "courses.aiCreativesMarketing.title",
    descriptionKey: "courses.aiCreativesMarketing.description",
    icon: "fas fa-palette",
    order: 5,
    difficulty: "intermediate",
    estimatedDuration: "6-8 hours",
  ...
  },
  {
    ...
    titleKey: "courses.aiStrategicPlanning.title",
    descriptionKey: "courses.aiStrategicPlanning.description",
    icon: "fas fa-chess",
    order: 6,
    difficulty: "advanced",
  ...
  },
  {
    ...
    titleKey: "courses.aiCreativityInnovation.title",
    descriptionKey: "courses.aiCreativityInnovation.description",
  ...
  },
  {
    ...
    titleKey: "courses.aiPoweredCoaching.title",
    descriptionKey: "courses.aiPoweredCoaching.description",
  ...
  {
    id: "ai-business-plan-development-execution",
    ...
    titleKey: "courses.aiBusinessPlanDevelopmentExecution.title",
    descriptionKey: "courses.aiBusinessPlanDevelopmentExecution.description",
  ...
  },
  {
    ...
    titleKey: "courses.aiResearchStudy.title",
    descriptionKey: "courses.aiResearchStudy.description",
  ...
  {
    id: "genai-data-analysis-decision-making",
    ...
    titleKey: "courses.genaiDataAnalysisDecisionMaking.title",
    descriptionKey: "courses.genaiDataAnalysisDecisionMaking.description",
...
export const MODULES = [
  ...
  // AI Fundamentals Modules
  {
    ...
    titleKey: "modules.aiFundamentalsBasics.title",
    descriptionKey: "modules.aiFundamentalsBasics.description",
    icon: "fas fa-brain",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-fundamentals-machine-learning",
    courseId: "ai-fundamentals",
    title: "Machine Learning Fundamentals",
    description: "Learn about machine learning, neural networks, and how AI systems learn from data.",
    titleKey: "modules.aiFundamentalsMachineLearning.title",
    descriptionKey: "modules.aiFundamentalsMachineLearning.description",
    icon: "fas fa-cogs",
    order: 2,
    content: {},
    isActive: true
  ...
  {
    id: "ai-fundamentals-applications",
    courseId: "ai-fundamentals",
    ...
    titleKey: "modules.aiFundamentalsApplications.title",
    descriptionKey: "modules.aiFundamentalsApplications.description",
    icon: "fas fa-globe",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-fundamentals-ethics-future",
    courseId: "ai-fundamentals",
    ...
    titleKey: "modules.aiFundamentalsEthicsFuture.title",
    descriptionKey: "modules.aiFundamentalsEthicsFuture.description",
  ...
  {
    id: "ai-productivity-automation-basics",
    courseId: "ai-productivity-improvement",
    title: "Automation Basics",
    description: "Learn how AI can automate repetitive tasks and streamline everyday workflows.",
    titleKey: "modules.aiProductivityAutomationBasics.title",
    descriptionKey: "modules.aiProductivityAutomationBasics.description",
    icon: "fas fa-robot",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-productivity-workflow-optimization",
    courseId: "ai-productivity-improvement",
    title: "Workflow Optimization",
    description: "Optimize business processes and personal workflows using AI-powered tools and strategies.",
    titleKey: "modules.aiProductivityWorkflowOptimization.title",
    descriptionKey: "modules.aiProductivityWorkflowOptimization.description",
    icon: "fas fa-stream",
    order: 2,
    content: {},
    isActive: true
  ...
  {
    id: "ai-productivity-time-management",
    courseId: "ai-productivity-improvement",
    ...
    titleKey: "modules.aiProductivityTimeManagement.title",
    descriptionKey: "modules.aiProductivityTimeManagement.description",
    icon: "fas fa-clock",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-productivity-collaboration-tools",
    courseId: "ai-productivity-improvement",
    ...
    titleKey: "modules.aiProductivityCollaborationTools.title",
    descriptionKey: "modules.aiProductivityCollaborationTools.description",
    icon: "fas fa-users",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "ai-critical-thinking-frameworks",
    courseId: "ai-critical-thinking-problem-solving",
    ...
    titleKey: "modules.aiCriticalThinkingFrameworks.title",
    descriptionKey: "modules.aiCriticalThinkingFrameworks.description",
    icon: "fas fa-brain",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-critical-thinking-decision-making",
    courseId: "ai-critical-thinking-problem-solving",
    ...
    titleKey: "modules.aiCriticalThinkingDecisionMaking.title",
    descriptionKey: "modules.aiCriticalThinkingDecisionMaking.description",
  ...
  {
    id: "ai-critical-thinking-problem-solving-methods",
    courseId: "ai-critical-thinking-problem-solving",
    ...
    titleKey: "modules.aiCriticalThinkingProblemSolvingMethods.title",
    descriptionKey: "modules.aiCriticalThinkingProblemSolvingMethods.description",
  ...
  {
    id: "ai-critical-thinking-logical-reasoning",
    courseId: "ai-critical-thinking-problem-solving",
    ...
    titleKey: "modules.aiCriticalThinkingLogicalReasoning.title",
    descriptionKey: "modules.aiCriticalThinkingLogicalReasoning.description",
    icon: "fas fa-search",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "ai-creatives-content-creation",
    courseId: "ai-creatives-marketing",
    title: "AI Content Creation",
    description: "Create compelling content using AI tools for writing, design, and multimedia production.",
    titleKey: "modules.aiCreativesContentCreation.title",
    descriptionKey: "modules.aiCreativesContentCreation.description",
  ...
  {
    id: "ai-creatives-design-tools",
    courseId: "ai-creatives-marketing",
    title: "AI Design Tools",
    description: "Master AI-powered design tools for graphics, logos, and visual content creation.",
    titleKey: "modules.aiCreativesDesignTools.title",
    descriptionKey: "modules.aiCreativesDesignTools.description",
  ...
  {
    id: "ai-creatives-campaign-optimization",
    courseId: "ai-creatives-marketing",
    title: "Campaign Optimization",
    description: "Optimize marketing campaigns using AI for targeting, personalization, and performance analysis.",
    titleKey: "modules.aiCreativesCampaignOptimization.title",
    descriptionKey: "modules.aiCreativesCampaignOptimization.description",
  ...
  {
    id: "ai-creatives-brand-strategy",
    courseId: "ai-creatives-marketing",
    title: "AI-Driven Brand Strategy",
    description: "Develop brand strategies and positioning using AI insights and market analysis.",
    titleKey: "modules.aiCreativesBrandStrategy.title",
    descriptionKey: "modules.aiCreativesBrandStrategy.description",
    icon: "fas fa-flag",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "ai-strategic-planning-business-strategy",
    courseId: "ai-strategic-planning",
    ...
    titleKey: "modules.aiStrategicPlanningBusinessStrategy.title",
    descriptionKey: "modules.aiStrategicPlanningBusinessStrategy.description",
  ...
  {
    id: "ai-strategic-planning-market-analysis",
    courseId: "ai-strategic-planning",
    ...
    titleKey: "modules.aiStrategicPlanningMarketAnalysis.title",
    descriptionKey: "modules.aiStrategicPlanningMarketAnalysis.description",
  ...
  {
    id: "ai-strategic-planning-competitive-intelligence",
    courseId: "ai-strategic-planning",
    title: "Competitive Intelligence",
    description: "Gather and analyze competitive intelligence using AI for strategic advantage.",
    titleKey: "modules.aiStrategicPlanningCompetitiveIntelligence.title",
    descriptionKey: "modules.aiStrategicPlanningCompetitiveIntelligence.description",
  ...
  {
    id: "ai-strategic-planning-implementation",
    courseId: "ai-strategic-planning",
    title: "Strategy Implementation",
    description: "Execute strategic plans effectively using AI for monitoring, adjustment, and optimization.",
    titleKey: "modules.aiStrategicPlanningImplementation.title",
    descriptionKey: "modules.aiStrategicPlanningImplementation.description",
    icon: "fas fa-cog",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "ai-creativity-ideation-techniques",
    courseId: "ai-creativity-innovation",
    ...
    titleKey: "modules.aiCreativityIdeationTechniques.title",
    descriptionKey: "modules.aiCreativityIdeationTechniques.description",
    icon: "fas fa-lightbulb",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-creativity-creative-processes",
    courseId: "ai-creativity-innovation",
    ...
    titleKey: "modules.aiCreativityCreativeProcesses.title",
    descriptionKey: "modules.aiCreativityCreativeProcesses.description",
    icon: "fas fa-palette",
    order: 2,
    content: {},
    isActive: true
  ...
  {
    id: "ai-creativity-innovation-frameworks",
    courseId: "ai-creativity-innovation",
    ...
    titleKey: "modules.aiCreativityInnovationFrameworks.title",
    descriptionKey: "modules.aiCreativityInnovationFrameworks.description",
    icon: "fas fa-rocket",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-creativity-breakthrough-thinking",
    courseId: "ai-creativity-innovation",
    ...
    titleKey: "modules.aiCreativityBreakthroughThinking.title",
    descriptionKey: "modules.aiCreativityBreakthroughThinking.description",
    icon: "fas fa-star",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "ai-coaching-fundamentals",
    courseId: "ai-powered-coaching",
    ...
    titleKey: "modules.aiCoachingFundamentals.title",
    descriptionKey: "modules.aiCoachingFundamentals.description",
  ...
  {
    id: "ai-coaching-skill-development",
    courseId: "ai-powered-coaching",
    ...
    titleKey: "modules.aiCoachingSkillDevelopment.title",
    descriptionKey: "modules.aiCoachingSkillDevelopment.description",
    icon: "fas fa-chart-line",
    order: 2,
    content: {},
    isActive: true
  ...
  {
    id: "ai-coaching-performance-optimization",
    courseId: "ai-powered-coaching",
    title: "Performance Optimization",
    description: "Optimize human performance using AI analytics and personalized coaching strategies.",
    titleKey: "modules.aiCoachingPerformanceOptimization.title",
    descriptionKey: "modules.aiCoachingPerformanceOptimization.description",
    icon: "fas fa-trophy",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-coaching-human-potential",
    courseId: "ai-powered-coaching",
    ...
    titleKey: "modules.aiCoachingHumanPotential.title",
    descriptionKey: "modules.aiCoachingHumanPotential.description",
  ...
  {
    id: "ai-business-plan-modeling",
    courseId: "ai-business-plan-development-execution",
    ...
    titleKey: "modules.aiBusinessPlanModeling.title",
    descriptionKey: "modules.aiBusinessPlanModeling.description",
    icon: "fas fa-building",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-business-plan-financial-projections",
    courseId: "ai-business-plan-development-execution",
    title: "Financial Projections",
    description: "Develop accurate financial projections and forecasts using AI-powered analysis tools.",
    titleKey: "modules.aiBusinessPlanFinancialProjections.title",
    descriptionKey: "modules.aiBusinessPlanFinancialProjections.description",
  ...
  {
    id: "ai-business-plan-strategy-development",
    courseId: "ai-business-plan-development-execution",
    title: "Strategy Development",
    description: "Formulate business strategies and go-to-market plans using AI insights and competitive analysis.",
    titleKey: "modules.aiBusinessPlanStrategyDevelopment.title",
    descriptionKey: "modules.aiBusinessPlanStrategyDevelopment.description",
    icon: "fas fa-compass",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-business-plan-execution-monitoring",
    courseId: "ai-business-plan-development-execution",
    ...
    titleKey: "modules.aiBusinessPlanExecutionMonitoring.title",
    descriptionKey: "modules.aiBusinessPlanExecutionMonitoring.description",
    icon: "fas fa-tasks",
    order: 4,
    content: {},
    isActive: true
  ...
  // AI Research & Study Modules
  {
    ...
    titleKey: "modules.aiResearchMethodology.title",
    descriptionKey: "modules.aiResearchMethodology.description",
    icon: "fas fa-search",
    order: 1,
    content: {},
    isActive: true
  ...
  {
    id: "ai-research-information-gathering",
    courseId: "ai-research-study",
    title: "Information Gathering",
    description: "Master AI-powered tools for data collection, literature review, and information synthesis.",
    titleKey: "modules.aiResearchInformationGathering.title",
    descriptionKey: "modules.aiResearchInformationGathering.description",
  ...
  {
    id: "ai-research-analysis-synthesis",
    courseId: "ai-research-study",
    ...
    titleKey: "modules.aiResearchAnalysisSynthesis.title",
    descriptionKey: "modules.aiResearchAnalysisSynthesis.description",
    icon: "fas fa-flask",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "ai-research-academic-writing",
    courseId: "ai-research-study",
    ...
    titleKey: "modules.aiResearchAcademicWriting.title",
    descriptionKey: "modules.aiResearchAcademicWriting.description",
    icon: "fas fa-pen",
    order: 4,
    content: {},
    isActive: true
  ...
  {
    id: "genai-data-analysis-fundamentals",
    courseId: "genai-data-analysis-decision-making",
    ...
    titleKey: "modules.genaiDataAnalysisFundamentals.title",
    descriptionKey: "modules.genaiDataAnalysisFundamentals.description",
  ...
  {
    id: "genai-data-analysis-statistical-methods",
    courseId: "genai-data-analysis-decision-making",
    ...
    titleKey: "modules.genaiDataAnalysisStatisticalMethods.title",
    descriptionKey: "modules.genaiDataAnalysisStatisticalMethods.description",
  ...
  {
    id: "genai-data-analysis-business-intelligence",
    courseId: "genai-data-analysis-decision-making",
    title: "Business Intelligence",
    description: "Transform data into actionable business intelligence using generative AI for insights and reporting.",
    titleKey: "modules.genaiDataAnalysisBusinessIntelligence.title",
    descriptionKey: "modules.genaiDataAnalysisBusinessIntelligence.description",
    icon: "fas fa-lightbulb",
    order: 3,
    content: {},
    isActive: true
  ...
  {
    id: "genai-data-analysis-decision-frameworks",
    courseId: "genai-data-analysis-decision-making",
    title: "Decision-making Frameworks",
    description: "Make informed decisions using GenAI-powered frameworks for data-driven decision making.",
    titleKey: "modules.genaiDataAnalysisDecisionFrameworks.title",
    descriptionKey: "modules.genaiDataAnalysisDecisionFrameworks.description",
    icon: "fas fa-crossroads",
    order: 4,
    content: {},
    isActive: true
